...
class EmptyState(IVendingMachineState):
    def select_product(self, product):
...
class DispensingProductState(IVendingMachineState):
    def select_product(self, product):
...
class WaitingForPaymentState(IVendingMachineState):
    def select_product(self, product):
...
class WaitingForProductSelectionState(IVendingMachineState):
    def select_product(self, product):
